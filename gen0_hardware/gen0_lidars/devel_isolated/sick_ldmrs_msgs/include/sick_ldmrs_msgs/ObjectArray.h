...
struct ObjectArray_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::sick_ldmrs_msgs::Object_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >> _objects_type;
