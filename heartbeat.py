...
#print(msg)
msg_data = msg.encode({'AutoDoorRequest':0,'AutoRampRequest':0,'StopStation':0,'AutoEstop':0,'PedestrianAlert':0,'HeadLight_Flash_Request':0,'c_Estop_PCNav_Not_Requested':1})
msg2_data = msg2.encode({'AutoDoorRequest':0,'AutoRampRequest':0,'StopStation':0,'AutoEstop':1,'PedestrianAlert':0,'HeadLight_Flash_Request':0,'c_Estop_PCNav_Not_Requested':1})
#print(msg_data)
